...
package com.dzm.ffmpeg.utils.rxpermissions;
...
public class RxPermissions {
    ...
    public RxPermissions(@NonNull final FragmentManager manager){
        mRxPermissionsFragment = getLazySingleton(manager);
    }
    ...
    public boolean checkPermissions(final String... permissions) {
        ...
        for (String permission : permissions) {
            granted &= ContextCompat.checkSelfPermission(Utils.getApplication(), permission) == PackageManager.PERMISSION_GRANTED;
        }
        return granted;
    }
