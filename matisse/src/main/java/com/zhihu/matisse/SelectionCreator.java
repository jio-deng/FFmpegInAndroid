...
public final class SelectionCreator {
    ...
    /**
     * Set listener for callback immediately when user click confirm.
     *
     * @param listener {@link OnConfirmedListener}
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator setOnConfirmedListener(@Nullable OnConfirmedListener listener) {
        mSelectionSpec.onConfirmedListener = listener;
        return this;
    }

    public SelectionCreator setTrackStatManager(TrackStatManager trackStatManager) {
        mSelectionSpec.mTrackStatManager = trackStatManager;
        return this;
    }
